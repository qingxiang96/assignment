...
public class AddProductUI extends javax.swing.JFrame {
    ...
    public AddProductUI(String name, String category, String description, double price, int barcode) {
        initComponents();
        jtxtName.setText(name);
        jtxtDescription.setText(description);
        jcmbCategory.getModel().setSelectedItem(category);
        jtxtPrice.setText(String.valueOf(price));
        jtxtBarcode.setText(String.valueOf(barcode));
    }
    
    public AddProductUI(String name, String barcode) {
        initComponents();
        jtxtName.setText(name);
    ...
    private void initComponents() {
        ...
        jcmbCategory = new javax.swing.JComboBox<String>();
    ...
    private void jbtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSaveActionPerformed
        ...
        if(!jtxtName.getText().trim().equals("") && !jtxtDescription.getText().trim().equals("") && !jtxtPrice.getText().trim().equals("")){
            ...
            Matcher m = p.matcher(jtxtPrice.getText());
            int nlength = name.length();
            int dlength = description.length();
        
            if(!m.matches()){
                JOptionPane.showMessageDialog(this, "Price must have at least 2 decimal.", "Error", 2);
            } else if(nlength <= 3){
                JOptionPane.showMessageDialog(this, "Name must be at least 3 characters", "Error", 2);
            } else if(nlength >= 20){
                JOptionPane.showMessageDialog(this, "Name must not more than 20 characters", "Error", 2);
            } else if(dlength <= 10){
                JOptionPane.showMessageDialog(this, "Description must be at least 10 characters", "Error", 2);
            } else if(dlength >= 50){
                JOptionPane.showMessageDialog(this, "Description must not more than 50 characters", "Error", 2);
            }
            else {
                new ProductListUI(name,category,description,price,barcode).setVisible(true);
                this.setVisible(false);
            }
        }
        else {
            JOptionPane.showMessageDialog(this, "Please fully key in the Product Details.", "Error", 2);
        }
